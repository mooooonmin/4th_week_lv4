...
import static com.level4.office.exception.CustomException.*;
...
public class JwtUtil {
    ...
    public boolean validateToken(String token) {
        ...
        } catch (SecurityException | MalformedJwtException | io.jsonwebtoken.security.SignatureException  | UnsupportedJwtException |
